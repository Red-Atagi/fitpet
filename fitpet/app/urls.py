...
urlpatterns = [
    ...
    path('friends/requests/', views.view_friend_requests, name="friend_request"),
    path('friends/requests/<str:action>/<int:from_user_id>', views.confirm_friend_request, name='confirm_friend_request'),
